 ...
 * @var \DataTrack\Model\Entity\Transaction[]|\Cake\Collection\CollectionInterface $transactions
 */
?>
    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('reftbl') ?></th>
